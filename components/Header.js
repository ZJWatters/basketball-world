        ...
        <div className="relative shadow-xl sm:overflow-hidden">
          <div className="absolute inset-0">
            <Image
              ...
              src="/hero.jpeg"
              alt="Basketball hoop reflecting off water"
              style={{ objectPosition: 'center top' }} // Adjust this to control the visible area
            />
          ...
          <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
            ...
            <h1 className="mt-1 text-center font-bold uppercase text-gray-900 sm:text-5xl sm:tracking-tight lg:text-7xl">
              <span className="block text-white">Life is not life without</span>
              <span className="block text-orange-500">Basketball</span>
            </h1>
